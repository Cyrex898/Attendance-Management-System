...
def subjectchoose(text_to_speech):
    ...
    def fethEn():
        ...
        with open(f'C:\\Users\\Parkash\\Desktop\\MPR-main\\Attendance\\{clas}\\studentdetails.csv', mode ='r') as df:
            csvFile = csv.DictReader(df)
            for lines in csvFile:
                data = lines

        df = pd.read_csv(f'C:\\Users\\Parkash\\Desktop\\MPR-main\\Attendance\\{clas}\\studentdetails.csv')  
        ...
        if not matching_rows.empty:
            ...
            try:
                ri = Image.open(f'C:\\Users\\Parkash\\Desktop\\MPR-main\\StudentImages\\{enroll}{Name}.jpg')
            except:
                ri = Image.open(f'C:\\Users\\Parkash\\Desktop\\MPR-main\\TrainingImage\\{enroll}_{Name}\\ {Name}_{enroll}_50.jpg')
            ...
            log = Image.open(f'C:\\Users\\Parkash\\Desktop\\MPR-main\\UI_Image\\IdLogo.png')
            new_size = (120, 120)
