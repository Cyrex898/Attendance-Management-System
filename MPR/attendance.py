...
haarcasecade_path = "C:\\Users\\Parkash\\Desktop\\MPR-main\\haarcascade_frontalface_default.xml"
trainimagelabel_path = (
    "C:\\Users\\Parkash\\Desktop\\MPR-main\\TrainingImageLabel\\Trainner.yml"
)
trainimage_path = "C:\\Users\\Parkash\\Desktop\\MPR-main\\TrainingImage"
studentdetail_path = (
    "C:\\Users\\Parkash\\Desktop\\MPR-main\\StudentDetails\\studentdetails.csv"
)
attendance_path = "C:\\Users\\Parkash\\Desktop\\MPR-main\\Attendance"


app = CTk()
app.title("Attendence Management Systsem through Face Recognition")
app.geometry("1400x740")
dialog_title = "QUIT"
...
class AttendanceGridCanvas:
    def __init__(self, parent, month, year, subject):
        ...
        self.students = self.load_students(f"C:\\Users\\Parkash\\Desktop\\MPR-main\\Attendance\\{self.subject}\\studentdetails.csv")
    ...
    def load_attendance(self):
        cwd = os.getcwd()
        files = glob.glob(os.path.join(cwd, f"C:\\Users\\Parkash\\Desktop\\MPR-main\\Attendance\\{self.subject}\\*.csv"))
